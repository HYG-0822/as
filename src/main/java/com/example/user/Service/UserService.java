...
public class UserService {
    ...
    public LoginUserResponseDTO login(LoginUserDTO loginUserDTO) {
        ...
        // User instance를 LoginUserResponseDTO instance로 변환하여 반환
